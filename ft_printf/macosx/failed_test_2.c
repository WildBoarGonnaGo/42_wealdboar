...
/*   Updated: 2020/07/27 19:08:04 by lchantel         ###   ########.fr       */
...
int	main(void)
{
	...
	result = printf("tr_test %.3d | %0*.*i|\n", count, 2, -1, 8);
	printf("result = %d\n", result);
	result = ft_printf("ft_test %.3d | %-2.4s|\n", ++count, NULL);
	ft_printf("result = %d\n", result);
	result = printf("tr_test %.3d | %-2.4s|\n", count, NULL);
	printf("result = %d\n", result);
	int r00 = 0;
	result = ft_printf("%%|\n");
	ft_printf("result = %d\n", result);
	result = printf("%%|\n");
	printf("result = %d\n", result);
	result = ft_printf("ft_test %.3d%%|\n", ++count);
	ft_printf("result = %d\n", result);
	result = printf("tr_test %.3d%%|\n", count);
	printf("result = %d\n", result);
	result = ft_printf("ft_test %.3d | lalala, %d%%|\n", ++count, r00);
	ft_printf("result = %d\n", result);
	result = printf("tr_test %.3d | lalala, %d%%|\n", count, r00);
	printf("result = %d\n", result);
	result = ft_printf("ft_test %.3d | lalala, %d%% des gens qui parlent à Ly adorent %s. Ou Presque. %p|\n", ++count, r00, "Ly", &r00);
	ft_printf("result = %d\n", result);
	result = printf("tr_test %.3d | lalala, %d%% des gens qui parlent à Ly adorent %s. Ou Presque. %p|\n", count, r00, "Ly", &r00);
	printf("result = %d\n", result);
