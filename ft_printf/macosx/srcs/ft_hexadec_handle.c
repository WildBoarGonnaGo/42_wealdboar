...
/*   Updated: 2020/07/31 00:06:58 by lchantel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			space_info_proc(int *sp_info, char **space_info,
			unsigned long long value, char **str_value)
{
	sp_info[3] = 0;
			...
			char space_char[3], int *len_res)
{
	...
	sp_info[3] += (!(int)value && **(space_info + 2) == '0') ? 1 : 0;
