...
{
	if (ft_strchr("NSWE", *(*(obj->map + pos[0]) + (obj->map_size[1] - 1 -pos[1]))) &&
	*(*(obj->map + pos[0]) + (obj->map_size[1] - 1 - pos[1])))
	{
		...
		if (*(*(obj->map + pos[0]) + (obj->map_size[1] - 1 - pos[1])) == 'E')
			ew_case(obj, -1);
		else if (*(*(obj->map + pos[0]) + (obj->map_size[1] - 1 - pos[1])) == 'W')
			ew_case(obj, 1);
		else if (*(*(obj->map + pos[0]) + (obj->map_size[1] - 1 - pos[1])) == 'N')
			ns_case(obj, -1);
		else if (*(*(obj->map + pos[0]) + (obj->map_size[1] - 1 - pos[1])) == 'S')
			ns_case(obj, 1);
